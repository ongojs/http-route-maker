 ...
 *
 * @module HTTPRouteMaker
 * @kind class
 *
 * @extends Base
 * @requires Base
 *
 * @classdesc HTTPRouteMaker class
 */
...
class HTTPRouteMaker extends require("./base") {
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(HTTPRouteMaker);
    // auto invoke methods
    this.autoinvoker(HTTPRouteMaker);
